...
$actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]" . (($_SERVER['SERVER_PORT'] !== "80") ? ':' . $_SERVER['SERVER_PORT'] : '') . "$_SERVER[REQUEST_URI]";
$base_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]" . (($_SERVER['SERVER_PORT'] !== "80") ? ':' . $_SERVER['SERVER_PORT'] : '') . $_SERVER['PHP_SELF'] . '?page=smtp_api';
...
<div class="wrap">
    ...
    <form method="post">
        ...
        <button type="submit" class="button button-primary" formaction="<?= $base_link ?>&editar">Atualizar
            dados</button>
        <button type="submit" class="button button-primary" formaction="<?= $base_link ?>&enviar">Enviar email de
            teste</button>
    </form>
</div>